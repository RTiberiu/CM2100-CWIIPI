...
/**
 * JavaFX MainApp
 * Project improved by Tiberiu Rociu - 2006061
 */
public class MainApp extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        scene = new Scene(loadFXML("hello-view", null), 640, 480);

        scene.getStylesheets().add("src/main/resources/styles/default.css"); //loads a default stylesheet -
